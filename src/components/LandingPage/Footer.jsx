            ...
            <div className="container py-5">
                <div className="row g-5">
                    <div className="col-lg-3 col-md-6">
                        ...
                        <p className="mb-2"><i className="fa fa-map-marker-alt text-primary me-3"></i>umban sari Street, Rumbai, USA (umban sari atas)</p>
                        <p className="mb-2"><i className="fa fa-phone-alt text-primary me-3"></i>+0628927231</p>
                        <p className="mb-2"><i className="fa fa-envelope text-primary me-3"></i>kel2@gmail.com</p>
